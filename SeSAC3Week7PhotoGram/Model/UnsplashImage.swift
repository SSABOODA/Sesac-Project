...
struct CoverPhotoTopicSubmissions: Codable {
    let nature, architectureInterior, colorOfWater, wallpapers: ArtsCulture?
    let texturesPatterns: ArtsCulture?
...
struct ResultTopicSubmissions: Codable {
    let wallpapers, artsCulture, innovation, texturesPatterns: ArtsCulture?
    let nature: ArtsCulture?
